...
//   - SchemeId  : capability scheme identifier (e.g. "ca", "cert", "mysql", "varwof-gateway-v1")
//   - CapabilityId : pure action identifier, **without scheme prefix** (e.g. "list", "issue", "SELECT:*")
//   - Full permission identifier = SchemeId + ":" + CapabilityId (e.g. "ca:list", "mysql:SELECT:*"),
...
// so a requested permission like "mysql:SELECT:*" matches an AIC declaration
// of {SchemeId:"mysql", CapabilityId:"SELECT:*"}.
...
// {SchemeId:"mysql", CapabilityId:"SELECT:*"} covers an AIC declaration of
// {SchemeId:"mysql", CapabilityId:"SELECT:/api/tables"}.
